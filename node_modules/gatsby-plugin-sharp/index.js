      ...
      if (job.file.extension === `png` && args.toFormat === `` || args.toFormat === `png`) {
        clonedPipeline.toBuffer().then(sharpBuffer => imagemin.buffer(sharpBuffer, {
          plugins: [imageminPngquant({
            ...
            speed: args.pngCompressionSpeed ? args.pngCompressionSpeed : undefined,
...
function queueImageResizing({
  ...
  const options = healOptions(pluginOptions, args, {}); // Filter out false args, and args not for this extension and put width at
...
function _fluid() {
  _fluid = (0, _asyncToGenerator2.default)(function* ({
    ...
    const options = healOptions(pluginOptions, args, {}); // Account for images with a high pixel density. We assume that these types of
...
function _fixed() {
  _fixed = (0, _asyncToGenerator2.default)(function* ({
    ...
    const options = healOptions(pluginOptions, args, {}); // if no width is passed, we need to resize the image based on the passed height
